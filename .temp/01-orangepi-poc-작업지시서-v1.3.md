...
- [ ] 2단계(ESP32) 일정 갱신 메모(BLE 필요 여부, BT transport 방식 반영)
...
7. ESP32-S3 개발 보드로 USB 호스트 enumerate(디스크립터 있음) — 2단계 계획서(`.temp/02-esp32-디바이스-계획서-v1.1.md`). BT transport가 확정되면 2단계 BLE/절전 범위 재산정.
